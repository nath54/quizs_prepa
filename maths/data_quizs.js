const quiz_logique = [{
    ...
    },
    {
        ...
        "resultat": "(A $ou B) $ou C $equivalent A $ou (b $ou C)"
    },
    {
        "type": "proposition",
        "titre": "Associativité du $et",
        "hypotheses": "A, B et C désignent des variables propositionnelles",
        "resultat": "(A $et B) $et C $equivalent A $et (B $et C)"
    },
    {
        "type": "proposition",
        "titre": "Distributivité du $ou",
        "hypotheses": "A, B et C désignent des variables propositionnelles",
        "resultat": "A $et(B $ou C) $equivalent(A $et B) $ou(A $et C)"
    },
    {
        "type": "proposition",
        "titre": "Distributé du $et",
        "hypotheses": "A, B et C désignent des variables propositionnelles",
        "resultat": " A $ou(B $et C) $equivalent(A $ou B) $et(A $ou C)"
    },
    {
        "type": "proposition",
        "titre": "Equivalence de l'impliquation",
        "hypotheses": "A, B et C désignent des variables propositionnelles",
        "resultat": "(A $implique B) $equivalent (B $ou $non A)"
    },
    {
        "type": "proposition",
        "titre": "Contraposée",
        "hypotheses": "A, B et C désignent des variables propositionnelles",
        "resultat": "(A $implique B) $equivalent ($non B $implique $non A)"
    }
];
