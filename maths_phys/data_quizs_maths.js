...
const quiz_nb_complexes = [{
    ...
    "hypotheses": "Soient $\\vec{u}$ un vecteur du plan d'affixe $z_u$, $A$ un point du plan, d'affixe $z_A$, $\\theta$ et $\\lambda$ des réels, et $D$ une droite passant par le point $A$ et de vecteur directeur $\\vec{u}$",
